...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [user]" DeleteCommand="DELETE FROM [user] WHERE [Id] = @Id" InsertCommand="INSERT INTO [user] ([Id], [password]) VALUES (@Id, @password)" UpdateCommand="UPDATE [user] SET [password] = @password WHERE [Id] = @Id">
            <DeleteParameters>
        ...
        <asp:ListView ID="ListView2" runat="server" DataKeyNames="Hospitalname" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem">
            <AlternatingItemTemplate>
                <tr style="">
                    <td>
                        <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="削除" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Hospital] WHERE [Hospitalname] = @Hospitalname" InsertCommand="INSERT INTO [Hospital] ([Hospitalname], [Callnumber], [Bedcount], [log], [Address], [Bedtype], [Bedinfected], [Bedmental], [Bedcovid], [Bedsevere]) VALUES (@Hospitalname, @Callnumber, @Bedcount, @log, @Address, @Bedtype, @Bedinfected, @Bedmental, @Bedcovid, @Bedsevere)" SelectCommand="SELECT * FROM [Hospital]" UpdateCommand="UPDATE [Hospital] SET [Callnumber] = @Callnumber, [Bedcount] = @Bedcount, [log] = @log, [Address] = @Address, [Bedtype] = @Bedtype, [Bedinfected] = @Bedinfected, [Bedmental] = @Bedmental, [Bedcovid] = @Bedcovid, [Bedsevere] = @Bedsevere WHERE [Hospitalname] = @Hospitalname">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Hospitalname], [Callllnumber], [Bedcount] FROM [Hospital]" DeleteCommand="DELETE FROM [Hospital] WHERE [Hospitalname] = @Hospitalname" InsertCommand="INSERT INTO [Hospital] ([Hospitalname], [Callllnumber], [Bedcount]) VALUES (@Hospitalname, @Callllnumber, @Bedcount)" UpdateCommand="UPDATE [Hospital] SET [Callllnumber] = @Callllnumber, [Bedcount] = @Bedcount WHERE [Hospitalname] = @Hospitalname">
            <DeleteParameters>
                <asp:Parameter Name="Hospitalname" Type="String" />
            </DeleteParameters>
            <InsertParameters>
                <asp:Parameter Name="Hospitalname" Type="String" />
                <asp:Parameter Name="Callllnumber" Type="Int32" />
                <asp:Parameter Name="Bedcount" Type="Int32" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="Callllnumber" Type="Int32" />
